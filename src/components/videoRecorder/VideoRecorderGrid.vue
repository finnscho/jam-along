    ...
    <v-layout >
      <v-app-bar fixed dense style="vertical-align: bottom;">
        <v-btn v-on:click="record">
          <v-icon v-bind:color="recording?'red':'orange'">mdi-record</v-icon>
        </v-btn>
        ...
        <v-btn v-on:click="children.push('Hallo')" v-on:mouseover="mouseoverAddBtn" v-on:mouseleave="mouseleaveAddBtn">
  ...
  <div class="grid-element">
    7
          ...
          <v-row>
            <v-col>
              <v-row>
                <v-col height:200px v-for="n in children" :key="n" cols="6" md="5">
                ...
                <v-col>
                  <div v-if="hover">
                    <div padding="10%"  style="width:560px;height:420px;border-style: dashed;border-color: orange;">
