  ...
  <v-content>
    <v-container fluid class="scroll">
      ...
      <v-row align="center" justify="center">
        <v-col cols="12">
          <v-card class="elevation-12">
            <v-toolbar dark flat>
              <v-toolbar-title class="primary--text">Disclaimer</v-toolbar-title>
              <v-spacer></v-spacer>
            </v-toolbar>
            <v-card-text>
              <h1>Disclaimer</h1>
              <p>
                ...
                between Website Operator (&quot;Website Operator&quot;, &quot;us&quot;,
                &quot;we&quot; or &quot;our&quot;) and you (&quot;User&quot;, &quot;you&quot; or
                &quot;your&quot;). This Disclaimer sets forth the general guidelines, terms and
                conditions of your use of the
                <a target="_blank" rel="nofollow" href="https://jam-along.azurewebsites.net"
                  >jam-along.azurewebsites.net</a
                >
              ...
              <p>
                Any views or opinions represented on the Website are personal and belong solely to
                Website Operator and do not represent those of people, institutions or organizations
                that the owner may or may not be associated with in professional or personal
                capacity unless explicitly stated. Any views or opinions are not intended to malign
              ...
              <p>
                ...
                otherwise without the express permission of Website Operator is prohibited.
              </p>
              <p>
                You may submit comments for the available Content on the Website. By uploading or
                otherwise making available any information to Website Operator, you grant Website
                Operator the unlimited, perpetual right to distribute, display, publish, reproduce,
                reuse and copy the information contained therein. You may not impersonate any other
                person through the Website. You may not post content that is defamatory, fraudulent,
              ...
              <p>
                ...
                Website is correct. Website Operator is not responsible for any errors or omissions,
                ...
                warranty of any kind, express or implied. In no event will Website Operator be
                liable to you or anyone else for any decision made or action taken in reliance on
                the information on the Website or for any consequential, special or similar damages,
                even if advised of the possibility of such damages.
              </p>
              <p>
                We reserve the right to modify this Disclaimer relating to the Website, products or
                services at any time, effective upon posting of an updated version of this
                Disclaimer on the Website. When we do we will revise the updated date at the bottom
                of this page. Continued use of the Website after any such changes shall constitute
                your consent to such changes. Policy was created with
                <a
                  style="color:inherit"
                  target="_blank"
                  title="Sample disclaimer template"
              ...
              <p>This document was last updated on May 12, 2020</p>
            </v-card-text>
          </v-card>
        </v-col>
      </v-row>
      <v-footer app>
        <span>&copy; 2020</span>
        <span>
          <router-link to="/home"><v-icon>mdi-home</v-icon></router-link>
        </span>
      </v-footer>
    </v-container>
  </v-content>
